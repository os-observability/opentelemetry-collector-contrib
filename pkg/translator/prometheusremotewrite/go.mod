module github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite
...
replace github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/prometheus => ../prometheus
