module github.com/os-observability/opentelemetry-collector-contrib/extension/awsproxy

go 1.19

require (
	github.com/os-observability/opentelemetry-collector-contrib/internal/aws/proxy v0.81.0
