module github.com/os-observability/opentelemetry-collector-contrib/internal/filter
...
replace github.com/os-observability/opentelemetry-collector-contrib/internal/coreinternal => ../coreinternal
