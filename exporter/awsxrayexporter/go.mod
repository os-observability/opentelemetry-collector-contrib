module github.com/os-observability/opentelemetry-collector-contrib/exporter/awsxrayexporter
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/internal/aws/xray v0.81.0
