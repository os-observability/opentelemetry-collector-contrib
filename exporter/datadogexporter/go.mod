module github.com/os-observability/opentelemetry-collector-contrib/exporter/datadogexporter
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.81.0
