module github.com/os-observability/opentelemetry-collector-contrib/exporter/zipkinexporter
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/zipkin v0.81.0
