module github.com/os-observability/opentelemetry-collector-contrib/processor/logstransformprocessor
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/stanza v0.81.0
