module github.com/os-observability/opentelemetry-collector-contrib/receiver/signalfxreceiver
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/signalfx v0.81.0
