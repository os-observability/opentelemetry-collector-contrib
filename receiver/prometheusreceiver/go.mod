module github.com/os-observability/opentelemetry-collector-contrib/receiver/prometheusreceiver
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/prometheus v0.81.0
