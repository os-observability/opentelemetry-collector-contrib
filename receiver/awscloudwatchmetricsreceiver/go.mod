module github.com/os-observability/opentelemetry-collector-contrib/receiver/awscloudwatchmetricsreceiver

go 1.19

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awscloudwatchmetricsreceiver v0.87.0
