module github.com/os-observability/opentelemetry-collector-contrib/receiver/windowsperfcountersreceiver
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/winperfcounters v0.81.0
