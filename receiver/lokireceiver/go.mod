module github.com/os-observability/opentelemetry-collector-contrib/receiver/lokireceiver
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/pkg/translator/loki v0.81.0
