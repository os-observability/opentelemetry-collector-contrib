module github.com/os-observability/opentelemetry-collector-contrib/receiver/activedirectorydsreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.87.0
