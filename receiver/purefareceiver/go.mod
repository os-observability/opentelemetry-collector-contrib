module github.com/os-observability/opentelemetry-collector-contrib/receiver/purefareceiver
...
replace github.com/os-observability/opentelemetry-collector-contrib/receiver/prometheusreceiver => ../prometheusreceiver
