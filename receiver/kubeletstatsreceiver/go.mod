module github.com/os-observability/opentelemetry-collector-contrib/receiver/kubeletstatsreceiver
...
require (
	...
	github.com/os-observability/opentelemetry-collector-contrib/internal/kubelet v0.81.0
